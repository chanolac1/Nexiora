 ...
 * NXM-0004 — NxVector
 *
 * Generic dynamic array for Nexiora Core Platform.
 * This container stores elements contiguously, uses Nexiora Memory Manager,
 * and supports selectable growth policies for performance/memory tradeoffs.
 */
