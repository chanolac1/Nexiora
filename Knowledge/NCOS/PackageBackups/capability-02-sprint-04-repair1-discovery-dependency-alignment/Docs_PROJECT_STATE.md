...
## NCOS-023 Repair5 — Pure Apply Discovery Policy
Automatic discovery now ignores legacy packages without the complete `apply.*` contract and selects only Pure Apply-compatible pending deliveries.
