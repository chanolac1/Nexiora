...
## Installation Certification Layer
`NxPackageManager_Apply` delega la evidencia final a `NxPackageCertification`, preservando trazabilidad incluso ante rollback.
