...
## Cognitive Core v2 — Goal Graph and Hierarchical Planning
Estado: entregado para certificación.

NX-CODE: Include/Nexiora/CognitiveV2/NxGoalGraph.h
NX-CODE: Source/CognitiveV2/NxGoalGraph.c
NX-CODE: Tools/CognitiveV2/NxGoalGraphTool.c
NX-CODE: Tests/Unit/NxGoalGraphTests.c

Capacidad: objetivos jerárquicos persistentes, dependencias, prioridades, detección de ciclos, selección determinista de tareas listas y transiciones verificables.
