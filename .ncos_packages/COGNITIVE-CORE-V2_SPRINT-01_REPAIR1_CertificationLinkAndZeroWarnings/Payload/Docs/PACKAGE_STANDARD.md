...
## Cognitive Core v2 artifacts
Los paquetes de capacidades con CLI deben declarar `artifact=` para la herramienta y su prueba. Pure Apply no puede recomendar Git si falta un artefacto o la certificación no termina en `CERTIFIED`.
