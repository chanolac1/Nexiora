...
## ADR — Goal Graph determinista antes de planificación generativa
Se adopta un grafo acíclico dirigido persistente como sustrato de planificación. Las tareas listas se ordenan por prioridad descendente y, en empate, por ID ascendente. La ejecución no puede marcar una tarea como completada mientras sus dependencias permanezcan incompletas.
