...
Run-Step { & $pm history 'TOOL-001 Repair2 Observable Progress' } 'history failed'
Write-Host 'TOOL-001 Repair2 verified: observable progress enabled, 0 warnings and all tests passed.'
