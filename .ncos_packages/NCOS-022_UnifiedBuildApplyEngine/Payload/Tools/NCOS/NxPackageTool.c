...
int main(int argc, char** argv)
{
    ...
    if (strcmp(argv[1], "apply") == 0) {
        ...
        printf("Estado           : %s\n", ok ? "APPLIED" : "FAILED");
        printf("Verify           : %s\n", apply_result.verify_ok ? "PASS" : "FAIL");
        printf("Dependencies     : %s\n", apply_result.dependencies_ok ? "PASS" : "FAIL");
        printf("Install          : %s\n", apply_result.install_ok ? "PASS" : "FAIL");
        printf("Configure        : %s\n", apply_result.configure_ok ? "PASS" : "FAIL");
        printf("Build            : %s\n", apply_result.build_ok ? "PASS" : "FAIL");
        printf("Warning gate     : %s\n", apply_result.warning_gate_ok ? "PASS" : "FAIL");
        printf("Tests            : %s\n", apply_result.tests_ok ? "PASS" : "FAIL");
        printf("Documentation    : %s\n", apply_result.documentation_ok ? "PASS" : "FAIL");
        printf("Rollback         : %s\n", apply_result.rollback_performed ? "DONE" : "NOT REQUIRED");
