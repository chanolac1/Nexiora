...
int main(void)
{
    ...
    if (!require_true(plan.workspace[0] != '.', "workspace remained relative")) { return 1; }
    if (!require_true(strstr(plan.download_command, "\".\"") == NULL, "command resolves root as executable")) { return 1; }
