...
$packageDir = Join-Path $rootPath ".ncos_packages\EPIC-03_SPRINT-03_MultimodalCognitiveIntegration"
...
try {
    ...
    Invoke-Checked { & $pm history "EPIC-03 Sprint-03 Multimodal Cognitive Integration" } "history falló"
    Write-Host "EPIC-03 Sprint-03 verified: 0 warnings, all tests passed, grounded multimodal reasoning enabled."
} finally { Pop-Location }
